...
<body style="margin: 0; padding: 0; font-family: Inter, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #ffffff; color: #18181b;">
  <div style="max-width: 500px; margin: 0 auto; padding: 24px 16px;">
    ...
    <div style="margin-bottom: 24px; border-bottom: 1px solid #e4e4e7; padding-bottom: 16px;">
      ...
      ${business.socialFacebook || business.socialInstagram || business.socialTwitter || business.socialLinkedin || business.socialYoutube || business.socialTiktok || business.socialWhatsapp ? `
      <table cellpadding="0" cellspacing="0" border="0">
        <tr>
          ${business.socialFacebook ? `<td style="padding-right: 8px;"><a href="https://facebook.com/${escapeHtml(business.socialFacebook)}" target="_blank" style="display: inline-block; padding: 6px 10px; background-color: #1877F2; border-radius: 6px; text-decoration: none; font-size: 11px; color: #ffffff; font-weight: 500;">Facebook</a></td>` : ""}
          ${business.socialInstagram ? `<td style="padding-right: 8px;"><a href="https://instagram.com/${escapeHtml(business.socialInstagram)}" target="_blank" style="display: inline-block; padding: 6px 10px; background-color: #E4405F; border-radius: 6px; text-decoration: none; font-size: 11px; color: #ffffff; font-weight: 500;">Instagram</a></td>` : ""}
          ${business.socialTwitter ? `<td style="padding-right: 8px;"><a href="https://x.com/${escapeHtml(business.socialTwitter)}" target="_blank" style="display: inline-block; padding: 6px 10px; background-color: #000000; border-radius: 6px; text-decoration: none; font-size: 11px; color: #ffffff; font-weight: 500;">X</a></td>` : ""}
          ${business.socialLinkedin ? `<td style="padding-right: 8px;"><a href="https://linkedin.com/in/${escapeHtml(business.socialLinkedin)}" target="_blank" style="display: inline-block; padding: 6px 10px; background-color: #0077B5; border-radius: 6px; text-decoration: none; font-size: 11px; color: #ffffff; font-weight: 500;">LinkedIn</a></td>` : ""}
          ${business.socialYoutube ? `<td style="padding-right: 8px;"><a href="https://youtube.com/@${escapeHtml(business.socialYoutube)}" target="_blank" style="display: inline-block; padding: 6px 10px; background-color: #FF0000; border-radius: 6px; text-decoration: none; font-size: 11px; color: #ffffff; font-weight: 500;">YouTube</a></td>` : ""}
          ${business.socialTiktok ? `<td style="padding-right: 8px;"><a href="https://tiktok.com/@${escapeHtml(business.socialTiktok)}" target="_blank" style="display: inline-block; padding: 6px 10px; background-color: #000000; border-radius: 6px; text-decoration: none; font-size: 11px; color: #ffffff; font-weight: 500;">TikTok</a></td>` : ""}
          ${business.socialWhatsapp ? `<td><a href="https://wa.me/${escapeHtml(business.socialWhatsapp.replace(/[^0-9]/g, ''))}" target="_blank" style="display: inline-block; padding: 6px 10px; background-color: #25D366; border-radius: 6px; text-decoration: none; font-size: 11px; color: #ffffff; font-weight: 500;">WhatsApp</a></td>` : ""}
        </tr>
      </table>
      ` : ""}
    </div>
      ...
      <table cellpadding="0" cellspacing="0" border="0" style="width: 100%;">
        <tr>
          ...
          <td style="width: 33.33%; text-align: center; padding: 0 4px;">
            <a href="${calendarLinks.apple}" target="_blank" style="display: inline-block; padding: 10px 16px; background-color: #000000; border-radius: 8px; text-decoration: none; font-size: 12px; color: #ffffff; font-weight: 500;">
              Apple
            </a>
          </td>
          ` : ""}
