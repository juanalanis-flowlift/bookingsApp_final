import { Settings, Sun, Moon, LogOut, CreditCard, Sparkles, Crown, Users, Check } from "lucide-react";
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-64" data-testid="settings-dropdown-menu">
        ...
        <DropdownMenuGroup>
          ...
          <DropdownMenuItem className="cursor-pointer text-destructive" data-testid="link-cancel-subscription">
